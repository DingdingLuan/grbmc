...
integer*4,parameter :: nsi=500,negamma=500,num=10000000,n=20,goalnum=50000
...
real*8 :: cnt(50),cnt1(50),cnt2(50),cntt90(50)
...
real*8 :: t901,t902,a1,a2,pea_erg,tn,threshold,prob,pvalue,repo,eps,Lp,Ep_prime
...
do i=1,nsi
  ...
  !   sfr=2.0**3.44
  !end if
	f_metal(i)=gammp(0.84d0,0.3**2*10.0**(0.3*z(i)))

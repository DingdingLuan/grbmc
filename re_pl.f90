...
integer*4,parameter :: nsi=500,negamma=500,num=50000,n=20,goalnum=50000
...
real*8 :: cnt(50),cnt1(50),cnt2(20),cntt90(50)
...
real*8 :: t901,t902,a1,a2,pea_erg,tn,threshold,eps,repo,Lp,fluence_sub,varep
...
A_egammao=1.0
egammao1=log_egammaoc-8.5;egammao2=log_egammaoc+8.5
...
!   endif								!classical method
	...
	enddo
	Eiso_pl(i)=s_2nd  ! Eiso in rest frame
...
inform='echo  | mailx -s "bpl模型完成提醒" dingding_luan@qq.com'
call system(inform)
